...
[Guid("4F59AF92-AA8D-4A20-8C8D-1C076647A6AE")]
public sealed class RemoteActivation : IRemoteActivation
{
    ...
    [DebuggerNonUserCode]
    IAsyncAction IRemoteActivation.DelayAsync(int ticks)
    {
    ...
    [DebuggerNonUserCode]
    IAsyncOperationWithProgress<IReadOnlyList<int>, ListProgress> IRemoteActivation.GenerateListAsync(ListOptions options)
    {
    ...
    [DebuggerNonUserCode]
    IAsyncActionWithProgress<LoopProgress> IRemoteActivation.LoopAsync(int total)
    {
